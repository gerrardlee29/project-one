...
As a Returning Visitor, I want to find information about what the gym has to offer.
As a Returning Visitor, I want to find the best way to get in contact with the gym with any questions I may have.
As a Returning Visitor, I want to find social medica links for gym.
-----------------------------------------------
Frequent User Goals

As a Frequent User, I want to check to see if there are any new promotions, deals, or hour changes.
